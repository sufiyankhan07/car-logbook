package com.cmtech.amslogbook.searchable_spinner;
...
public class CircularImageView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    public enum ShadowGravity {
        ...
        public int getValue() {
            ...
            throw new IllegalArgumentException("Not key available for this ShadowGravity: " + this);
        }
        ...
        public static ShadowGravity fromValue(int value) {
            ...
            throw new IllegalArgumentException("This key is not supported for ShadowGravity: " + value);
        }
