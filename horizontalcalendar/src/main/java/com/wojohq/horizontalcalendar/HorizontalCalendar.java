package com.wojohq.horizontalcalendar;
...
import com.wojohq.horizontalcalendar.adapter.DaysAdapter;
import com.wojohq.horizontalcalendar.adapter.HorizontalCalendarBaseAdapter;
import com.wojohq.horizontalcalendar.adapter.MonthsAdapter;
import com.wojohq.horizontalcalendar.model.CalendarItemStyle;
import com.wojohq.horizontalcalendar.model.HorizontalCalendarConfig;
...
import com.wojohq.horizontalcalendar.utils.HorizontalSnapHelper;
...
public final class HorizontalCalendar {
    ...
    void init(View rootView, final Calendar defaultSelectedDate, HorizontalCalendarPredicate disablePredicate, CalendarEventsPredicate eventsPredicate) {
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                centerCalendarToPosition(positionOfDate(defaultSelectedDate));
            }
        });
    ...
    public void centerCalendarToPosition(final int position) {
        if (position != -1) {
            ...
            refreshItemsSelector(position,selectedDatePosition);
    ...
    public void updateEvents(CalendarEventsPredicate calendarEventsPredicate) {
        mCalendarAdapter.updateEvents(calendarEventsPredicate);
    }
